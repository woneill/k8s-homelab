module "mercury" {
  ...
  source = "github.com/poseidon/typhoon//bare-metal/flatcar-linux/kubernetes?ref=v1.29.0"
...
module "mercury_worker" {
  # The tag here maps to the Kubernetes version
  source = "github.com/poseidon/typhoon//bare-metal/flatcar-linux/kubernetes/worker?ref=v1.29.0"
